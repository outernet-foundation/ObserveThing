...
//         private List<ListOpArgs<T>> Peek<T>(IObservable<ListOpArgs<T>> observable)
//         {
//             List<ListOpArgs<T>> result = new List<ListOpArgs<T>>();
...
//         private void AreEqual<T>(IEnumerable<T> expected, IObservable<ListOpArgs<T>> observable)
