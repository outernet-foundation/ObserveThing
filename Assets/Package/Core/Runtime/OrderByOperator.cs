...
{
    public class OrderByOperator<T, U> : IDisposable
    {
        ...
        public OrderByOperator(ICollectionOperator<T> collection, Func<T, IValueOperator<U>> orderBy, bool descending, IListObserver<T> receiver)
        {
            _orderBy = orderBy;
