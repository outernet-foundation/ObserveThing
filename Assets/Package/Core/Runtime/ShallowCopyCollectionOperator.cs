...
{
    public class ShallowCopyCollectionOperator<T> : IDisposable
    {
        ...
        public ShallowCopyCollectionOperator(ICollectionOperator<IValueOperator<T>> source, ICollectionObserver<T> receiver)
        {
            _receiver = receiver;
