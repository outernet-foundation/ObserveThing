...
{
    public class ConcatOperator<T> : IDisposable
    {
        ...
        public ConcatOperator(ICollectionOperator<T> source1, ICollectionOperator<T> source2, ICollectionObserver<T> receiver)
        {
            _receiver = receiver;
