...
{
    public class CombineValueOperator<T1, T2> : IDisposable
    {
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueObserver<(T1, T2)> receiver)
        {
            _receiver = receiver;
    ...
    public class CombineValueOperator<T1, T2, T3> : IDisposable
    {
        private IDisposable _sourceStream;
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueOperator<T3> source3, IValueObserver<(T1, T2, T3)> receiver)
        {
            _receiver = receiver;
            _sourceStream = new ComposedDisposable(
    ...
    public class CombineValueOperator<T1, T2, T3, T4> : IDisposable
    {
        private IDisposable _sourceStream;
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueOperator<T3> source3, IValueOperator<T4> source4, IValueObserver<(T1, T2, T3, T4)> receiver)
        {
            _receiver = receiver;
            _sourceStream = new ComposedDisposable(
    ...
    public class CombineValueOperator<T1, T2, T3, T4, T5> : IDisposable
    {
        private IDisposable _sourceStream;
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueOperator<T3> source3, IValueOperator<T4> source4, IValueOperator<T5> source5, IValueObserver<(T1, T2, T3, T4, T5)> receiver)
        {
            _receiver = receiver;
            _sourceStream = new ComposedDisposable(
    ...
    public class CombineValueOperator<T1, T2, T3, T4, T5, T6> : IDisposable
    {
        private IDisposable _sourceStream;
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueOperator<T3> source3, IValueOperator<T4> source4, IValueOperator<T5> source5, IValueOperator<T6> source6, IValueObserver<(T1, T2, T3, T4, T5, T6)> receiver)
        {
            _receiver = receiver;
            _sourceStream = new ComposedDisposable(
    ...
    public class CombineValueOperator<T1, T2, T3, T4, T5, T6, T7> : IDisposable
    {
        private IDisposable _sourceStream;
        ...
        public CombineValueOperator(IValueOperator<T1> source1, IValueOperator<T2> source2, IValueOperator<T3> source3, IValueOperator<T4> source4, IValueOperator<T5> source5, IValueOperator<T6> source6, IValueOperator<T7> source7, IValueObserver<(T1, T2, T3, T4, T5, T6, T7)> receiver)
        {
            _receiver = receiver;
            _sourceStream = new ComposedDisposable(
