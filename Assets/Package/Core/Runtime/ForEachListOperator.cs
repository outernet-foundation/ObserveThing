...
{
    public class ForEachListOperator<T> : IDisposable
    {
        ...
        public ForEachListOperator(IListOperator<T> source, IListObserver<T> forEachReceiver, IListObserver<T> receiver)
        {
