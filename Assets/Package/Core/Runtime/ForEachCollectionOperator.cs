...
{
    public class ForEachCollectionOperator<T> : IDisposable
    {
        ...
        public ForEachCollectionOperator(ICollectionOperator<T> source, ICollectionObserver<T> forEachReceiver, ICollectionObserver<T> receiver)
        {
