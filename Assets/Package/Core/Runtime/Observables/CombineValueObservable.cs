...
namespace ObserveThing
{
    public class CombineValueObservable<T1, T2> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IValueOperand<(T1, T2)> operand)
        {
            _operand = operand;
    ...
    public class CombineValueObservable<T1, T2, T3> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IValueOperand<(T1, T2, T3)> operand)
        {
            _operand = operand;
            _subscriptions = new ComposedDisposable(
    ...
    public class CombineValueObservable<T1, T2, T3, T4> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IValueOperand<(T1, T2, T3, T4)> operand)
        {
            _operand = operand;
            _subscriptions = new ComposedDisposable(
    ...
    public class CombineValueObservable<T1, T2, T3, T4, T5> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IObservable<T5> source5, IValueOperand<(T1, T2, T3, T4, T5)> operand)
        {
            _operand = operand;
            _subscriptions = new ComposedDisposable(
    ...
    public class CombineValueObservable<T1, T2, T3, T4, T5, T6> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IObservable<T5> source5, IObservable<T6> source6, IValueOperand<(T1, T2, T3, T4, T5, T6)> operand)
        {
            _operand = operand;
            _subscriptions = new ComposedDisposable(
    ...
    public class CombineValueObservable<T1, T2, T3, T4, T5, T6, T7> : IDisposable
    {
        ...
        public CombineValueObservable(IObservable<T1> source1, IObservable<T2> source2, IObservable<T3> source3, IObservable<T4> source4, IObservable<T5> source5, IObservable<T6> source6, IObservable<T7> source7, IValueOperand<(T1, T2, T3, T4, T5, T6, T7)> operand)
        {
            _operand = operand;
            _subscriptions = new ComposedDisposable(
