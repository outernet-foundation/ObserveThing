...
namespace ObserveThing
{
    public class ShallowCopyListObservable<T> : IDisposable
    {
        ...
        public ShallowCopyListObservable(IObservable<CollectionOp<ListData<IObservable<T>>>> source, IListOperand<T> operand)
        {
            _operand = operand;
        ...
        private void HandleAdd(int index, IObservable<T> element)
        {
        ...
        private void HandleRemove(int index, IObservable<T> element)
        {
