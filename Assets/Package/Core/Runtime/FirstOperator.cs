...
{
    public class FirstOperator<T> : IDisposable
    {
        ...
        public FirstOperator(ICollectionOperator<T> source, Func<T, IValueOperator<bool>> validate, IValueObserver<(bool found, T value)> receiver)
        {
            _receiver = receiver;
