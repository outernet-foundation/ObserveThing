...
{
    public class ShareDictionaryOperator<TKey, TValue> : IDictionaryOperator<TKey, TValue>
    {
        ...
        public ShareDictionaryOperator(IDictionaryOperator<TKey, TValue> source)
        {
            _source = source;
            _shared = new DictionaryObservable<TKey, TValue>(new ObservationContext());
        }
