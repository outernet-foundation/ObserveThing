...
{
    public class ForEachDictionaryOperator<TKey, TValue> : IDisposable
    {
        ...
        public ForEachDictionaryOperator(IDictionaryOperator<TKey, TValue> source, IDictionaryObserver<TKey, TValue> forEachReceiver, IDictionaryObserver<TKey, TValue> receiver)
        {
