...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        private void Grow(int minCapacity)
        {
            ...
            if ((uint)newcapacity > 2000000000) newcapacity = 2000000000;
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                {
                    throw new ArgumentException("array's lower bound must be 0.");
                }

                if (index < 0 || index > array.Length)
                {
                    throw new ArgumentOutOfRangeException(nameof(index), index, "Index must be at least 0 and less than array.Length");
                }
                ...
                {
                    throw new ArgumentException("array is of the incorrect type.");
                }
            }
