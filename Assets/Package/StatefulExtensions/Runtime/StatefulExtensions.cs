...
namespace ObserveThing.StatefulExtensions
{
    public static class Extensions
    {
        public static ICollectionObservable<PrimitiveMapPair<TLeft, TRight>> ToObservable<TLeft, TRight>(this ObservablePrimitiveMap<TLeft, TRight> map)
            => new CollectionObservableFactory<PrimitiveMapPair<TLeft, TRight>>(receiver => new StatefulPrimitiveMapObservable<TLeft, TRight>(map, receiver));
        ...
        public static IValueObservable<IReadOnlyCollection<T>> ToObservable<T>(this ObservablePrimitiveArray<T> primitiveArray)
            => new ValueObservableFactory<IReadOnlyCollection<T>>(receiver => new StatefulPrimitiveArrayObservable<T>(primitiveArray, receiver));
        ...
        public static IDictionaryObservable<TKey, TValue> ToObservable<TKey, TValue>(this ObservableDictionary<TKey, TValue> dictionary)
            where TValue : IObservableNode, new() => new DictionaryObservableFactory<TKey, TValue>(receiver => new StatefulDictionaryObservable<TKey, TValue>(dictionary, receiver));
        ...
        public static IListObservable<T> ToObservable<T>(this ObservableList<T> list)
            where T : IObservableNode, new() => new ListObservableFactory<T>(receiver => new StatefulListObservable<T>(list, receiver));
        ...
        public static IListObservable<object> ToObservable(this IObservableList list)
            => new ListObservableFactory<object>(receiver => new StatefulListObservable(list, receiver));
        ...
        public static ICollectionObservable<T> ToObservable<T>(this ObservableSet<T> set)
            => new CollectionObservableFactory<T>(receiver => new StatefulSetObservable<T>(set, receiver));
        ...
        public static IValueObservable<T> ToObservable<T>(this ObservablePrimitive<T> primitive)
            => new ValueObservableFactory<T>(receiver => new StatefulPrimitiveObservable<T>(primitive, receiver));
        ...
        public static IValueObservable<object> ToObservable(this IObservablePrimitive primitive)
            => new ValueObservableFactory<object>(receiver => new StatefulPrimitiveObservable(primitive, receiver));
